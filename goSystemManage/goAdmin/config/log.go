...
func init() {
	...
	global.GLOBAL_LOG = logger
}

func registerStdout(c base.Log, backends []oplogging.Backend) []oplogging.Backend {
	if c.Stdout != "" {
...
func registerFile(c base.Log, backends []oplogging.Backend) []oplogging.Backend {
	if c.File != "" {
...
func createBackend(w io.Writer, c base.Log, level oplogging.Level) oplogging.Backend {
...
func getLogFormatter(c base.Log, stdoutWriter bool) oplogging.Formatter {
